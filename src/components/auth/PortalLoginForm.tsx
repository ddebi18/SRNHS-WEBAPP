    ...
    <div className="min-h-screen bg-cream dark:bg-[#0F1714] flex items-center justify-center p-6 transition-colors">
      <div className="w-full max-w-4xl grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
        ...
        <motion.div
          ...
          className="bg-white/85 dark:bg-slate-900/85 backdrop-blur-md rounded-3xl border border-slate-200/60 dark:border-slate-800 shadow-card p-8 space-y-6 transition-all glow-emerald"
        >
          <div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <motion.button
              ...
              className="w-full py-3.5 px-4 rounded-2xl bg-gradient-to-r from-emerald-600 via-teal-600 to-emerald-700 text-white text-sm font-black
                flex items-center justify-center gap-2 shadow-md shadow-emerald-950/20 mt-2
                hover:brightness-105 disabled:opacity-50 transition-all cursor-pointer"
            >
              {loading ? (
