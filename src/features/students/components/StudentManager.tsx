    ...
    <div className="space-y-8">
        ...
        <div className="flex items-center gap-2 self-start sm:self-auto">
          ...
          {isAdmin && (
            <button
              ...
              className="px-4 py-2 text-xs font-semibold rounded-xl bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-500 hover:to-teal-500 text-white flex items-center gap-1.5 shadow-sm shadow-emerald-900/20 transition-all cursor-pointer"
            >
      ...
      <div className="pt-6 border-t border-slate-200 dark:border-slate-800">
        ...
        <div className="space-y-3">
          {violations.map(v => (
            <div key={v.id} className="p-4 rounded-2xl bg-white/80 dark:bg-slate-900/80 backdrop-blur-sm border border-slate-200/60 dark:border-slate-800 shadow-card-sm flex flex-col sm:flex-row sm:items-center justify-between gap-3 transition-colors">
              <div>
